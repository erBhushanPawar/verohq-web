              ...
              <CardFooter className="flex flex-col pt-0">
                ...
                >
                  {testimonial.avatarSrc ? (
                    ...
                    <div className="bg-primary/10 text-primary ring-border/20 group-hover:ring-primary/30 flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full ring-2 transition-all duration-200">
